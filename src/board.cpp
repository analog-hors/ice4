            ...
            for (int rank = 6; rank > 0; rank--) {
                ...
                if (board[sq] == own_pawn) {
                    pawn_eval += PASSER_RANK[rank-1]
                        + own_king_dist * PASSER_OWN_KING_DIST
                        + own_king_dist * own_king_dist / 3 * PASSER_OWN_KING_DIST_SQUARED
                        + enemy_king_dist * PASSER_ENEMY_KING_DIST
                        + enemy_king_dist * enemy_king_dist / 3 * PASSER_ENEMY_KING_DIST_SQUARED;
                }
