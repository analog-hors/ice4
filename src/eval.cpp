// loss: 0.07862    train id: 2024-10-25-20-35-04-frzn-big3
...
#define DATA_STRING L">WT><83'@KA<:6*'BHRNLA2-HR[[TGA5V_}lhdRD, HVO?>;my§  .4;=>5,MXZXV`N  *)$(&/&, \" ,;9; #*/500+394-*2'  !#$%&*'a^= #P_rFJ9 1-QN ),2$ %00f\\^VW[anh\\ ^\\adcWLZ\\jÃ  '.3'*(+$&--,'''(-%$!&,*44)$\"*/5CL6(\"+;<VZT4267; 5JT\\I=9#5HLJD7  !//2.0<$(',)-'   &/20::,-.)#&# \" @Vdena +6<==8:(1=FPWN %8AHAA4 :\" \" 0MmË>f\\MFHGF> ;Q]flp #1KƟ"
...
#define THREATENED_BY_PAWN S(-34, -20)
