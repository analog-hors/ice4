...
def to_evalcpp(last_loss, train_id, param_map):
    ...
    mg = deque(v * 100 for v in param_map["mg.weight"][0] + param_map["king_attack.weight"][0])
    eg = deque(v * 100 for v in param_map["eg.weight"][0] + [0] * len(param_map["king_attack.weight"][0]))
