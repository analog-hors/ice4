...
def to_evalcpp(last_loss, train_id, param_map):
    ...
    define_param("PASSER_OWN_KING_DIST")
    define_param("PASSER_OWN_KING_DIST_SQUARED")
    define_param("PASSER_ENEMY_KING_DIST")
    define_param("PASSER_ENEMY_KING_DIST_SQUARED")
